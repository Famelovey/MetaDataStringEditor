...
namespace MetaDataStringEditor {
    class MetadataFile : IDisposable {
        ...
        public MetadataFile(string fullName) {
            ...
            Logger.I("Reading complete.");
        }

        private void ReadHeader() {
            Logger.I("Reading file header...");
